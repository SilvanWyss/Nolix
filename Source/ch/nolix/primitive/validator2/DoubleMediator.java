...
import ch.nolix.primitive.invalidArgumentException.BiggerArgumentException;
import ch.nolix.primitive.invalidArgumentException.EmptyArgumentException;
import ch.nolix.primitive.invalidArgumentException.EqualArgumentException;
...
import ch.nolix.primitive.invalidArgumentException.OutOfRangeArgumentException;
import ch.nolix.primitive.invalidArgumentException.SmallerArgumentException;
import ch.nolix.primitive.invalidArgumentException.UnequalArgumentException;
import ch.nolix.primitive.invalidArgumentException.ZeroArgumentException;
...
public class DoubleMediator extends Mediator {
	...
	/**
	 * Creates new double mediator for the given argument.
	 * 
	 * @param argument
	 */
	...
	//package-visible constructor
	/**
	 * Creates new double mediator for the given argument with the given argument name.
	 * 
	 * @param argumentName
	 * @param argument
