...
public final class BorderWidgetContentArea<BW extends BorderWidget<BW, BWL>, BWL extends BorderWidgetLook<BWL>> {
	...
	public int getXPositionOnScrolledArea() {
		...
		switch (parentBorderWidget.getContentPosition()) {
			...
			case Center:
			case Bottom:
				return (parentBorderWidget.getScrolledAreaWidth() - parentBorderWidget.getContentAreaWidth()) / 2;
			case RightTop:
			case Right:
			case RightBottom:				
				return
				parentBorderWidget.getScrolledAreaWidth()
	...
	public int getYPositionOnScrolledArea() {
		...
		switch (parentBorderWidget.getContentPosition()) {
			...
			case Center:
			case Right:
				return (parentBorderWidget.getScrolledAreaHeight() - parentBorderWidget.getContentAreaHeight()) / 2;
			case LeftBottom:
			case Bottom:
			case RightBottom:
				return
				parentBorderWidget.getScrolledAreaHeight()
