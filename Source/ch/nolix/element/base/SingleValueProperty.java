 ...
 * @month 2018-03
 * @lines 160
 * @param <V> The type of the value of a {@link SingleValueProperty}.
 */
abstract class SingleValueProperty<V> extends Property<V> {
	...
	//constructor
	/**
	 * Creates a new {@link SingleValueProperty} with the given name, setterMethod, valueCreator and specificationCreator.
	 * 
	 * @param name
	 * @param setterMethod
	 * @param valueCreator
	...
	//method
	/**
	 * @return true if the current {@link SingleValueProperty} has a value.
	 */
	...
	//method
	/**
	 * @return the value of the current {@link SingleValueProperty}.
	 * @throws ArgumentDoesNotHaveAttributeException if the current {@link SingleValueProperty} does not have a value.
	 */
	...
	//method
	/**
	 * @return true if the current {@link SingleValueProperty} does not have a value.
	 */
	@Override
	...
	//method declaration
	/**
	 * @return true if the current {@link SingleValueProperty} is optional.
	 */
	public abstract boolean isOptional();
	
	//method
	/**
	 * Sets the value of the current {@link SingleValueProperty}.
	 * 
	 * @param value
	 * @throws ArgumentIsNullException if the given value is null.
	 * @throws InvalidArgumentException if the current {@link SingleValueProperty} is not mutable and has already a value.
	 */
	...
	//method
	/**
	 * Removes the value of the current {@link SingleValueProperty}.
	 * 
	 * @return the current {@link SingleValueProperty}.
	 */
	void clear() {	
		value = null;
	}
