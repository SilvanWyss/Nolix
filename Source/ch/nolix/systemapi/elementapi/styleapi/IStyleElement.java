...
//interface
/**
 * A {@link IStyleElement} can have a {@link IStyle} to apply to itself and to its child elements.
 * 
 * @author Silvan Wyss
 * @date 2022-07-23
...
public interface IStyleElement<SE extends IStyleElement<SE>> extends IStylableElement<SE> {
	...
	//method declaration
	/**
	 * Applies the {@link IStyle} of the current {@link IStyleElement} to
	 * the current {@link IStyleElement} and its child elements if
	 * the current {@link IStyleElement} has a {{@link IStyle}
	 */
