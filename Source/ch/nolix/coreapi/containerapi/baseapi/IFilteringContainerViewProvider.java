 ...
 * @author Silvan Wyss
 * @version 2025-03-09
 * @param <E> is the type of the elements of a {@link IFilteringContainerViewProvider}.
 */
public interface IFilteringContainerViewProvider<E> {
   ...
   *         selects from the current {@link IFilteringContainerViewProvider}. Ignores null
   *         elements.
