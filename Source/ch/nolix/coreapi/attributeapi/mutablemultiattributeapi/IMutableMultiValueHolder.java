...
//interface
/**
* A {@link IMutableMultiValueHolder} is a {@link IMultiValueHolder} whose values
...
public interface IMutableMultiValueHolder<V> extends IMultiValueHolder<V> {
	 ...
	 * 
	 * @param value
	 * @throws RuntimeException if the current {@link IMutableMultiValueHolder} does not contain the given value.
	 */
