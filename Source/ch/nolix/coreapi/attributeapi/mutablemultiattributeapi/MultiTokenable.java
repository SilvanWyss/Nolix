...
//interface
/**
* A {@link MultiTokenable} is a {@link MultiTokened} whose tokens can be added and removed programmatically.
* 
* @author Silvan Wyss
* @date 2023-07-16
*/
public interface MultiTokenable extends MultiTokened {
	...
	//method declaration
	/**
	 * Removes the token that equals the given token from the current {@link MultiTokenable} if
	 * the current {@link MultiTokenable} contains such a token.
	 * 
	 * @param token
	 */
