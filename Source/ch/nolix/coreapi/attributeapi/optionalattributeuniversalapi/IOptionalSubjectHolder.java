...
public interface IOptionalSubjectHolder {
	 ...
	 * @throws RuntimeException if the current {@link IOptionalSubjectHolder} does not have a subject.
	 */
	String getSubject();
	
	//method declaration
	/**
	 * @return the subject of the current {@link IOptionalSubjectHolder} if it has a subject, otherwise
	...
	/**
	 * @param subject
	 * @return true if the current {@link IOptionalSubjectHolder} has the given subject.
	 */
