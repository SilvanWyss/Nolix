...
//interface
/**
 * A {@link OptionalQualifiedNamed} is a {@link Named} that
 * can have a qualifying prefix that completes the name of the {@link OptionalQualifiedNamed} to a qualified name.
 * 
 * @author Silvan Wyss
 * @date 2023-02-07
 */
...
public interface OptionalQualifiedNamed extends Named {
	 ...
	 * @throws RuntimeException if the current {@link OptionalQualifiedNamed} does not have a qualifying prefix.
	 */
	...
	//method
	/**
	 * @return the qualified name of the current {@link OptionalQualifiedNamed} in quotes.
	 * @throws RuntimeException if the current {@link OptionalQualifiedNamed} does not have a qualifying prefix.
	 */
	...
	//method declaration
	/**
	 * @return true if the current {@link OptionalQualifiedNamed} has a qualifying prefix, false otherwise.
	 */
