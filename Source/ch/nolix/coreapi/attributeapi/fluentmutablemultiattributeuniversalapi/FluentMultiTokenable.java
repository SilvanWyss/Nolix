//package declaration
package ch.nolix.coreapi.attributeapi.fluentmutablemultiattributeuniversalapi;

//own imports
import ch.nolix.coreapi.attributeapi.multiattributeuniversalapi.MultiTokened;
...
public interface FluentMultiTokenable<MT extends FluentMultiTokenable<MT>> extends MultiTokened {
	...
	//method declaration
	/**
	 * Removes the token that equals the given token from the current {@link FluentMultiTokenable} if
	 * the current {@link FluentMultiTokenable} contains such a token.
	 * 
	 * @param token
	 * @return the current {@link FluentMultiTokenable}.
	 */
