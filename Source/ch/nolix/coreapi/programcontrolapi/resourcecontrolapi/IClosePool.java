...
public interface IClosePool {
	 ...
	 * @throws RuntimeException if the current {@link IClosePool} contains already one of the given elements.
	 */
	void addElements(IContainer<GroupCloseable> elements);
	
	//method declaration
	/**
	 * Closes the elements of the current {@link IClosePool} if
