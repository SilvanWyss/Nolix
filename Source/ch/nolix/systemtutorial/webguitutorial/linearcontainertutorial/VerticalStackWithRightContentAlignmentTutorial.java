...
public final class VerticalStackWithRightContentAlignmentTutorial {
	...
	private static final class MainSession extends WebClientSession<Object> {
		...
		protected void initialize() {
			...
			label2.getOriStyle().setTextSizeForState(ControlState.BASE, 20);
			label3.getOriStyle().setTextSizeForState(ControlState.BASE, 20);
			label4.getOriStyle().setTextSizeForState(ControlState.BASE, 20);
