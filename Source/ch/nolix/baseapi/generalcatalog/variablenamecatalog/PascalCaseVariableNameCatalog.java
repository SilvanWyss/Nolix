 ...
 * @author Silvan Wyss
 */
public final class PascalCaseVariableNameCatalog {
  ...
  /**
   * Prevents that an instance of the {@link PascalCaseVariableNameCatalog} can be
   * created.
   */
  private PascalCaseVariableNameCatalog() {
  }
}
