...
/**
 * Of the {@link PluralPascalCaseVariableNameCatalog} an instance cannot be
 * created.
 * 
 * @author Silvan Wyss
 */
public final class PluralPascalCaseVariableNameCatalog {
  ...
  public static final String VALUE_SUPPLIERS = "ValueSuppliers";
  ...
  /**
   * Prevents that an instance of the {@link PluralPascalCaseVariableNameCatalog}
   * can be created.
   */
