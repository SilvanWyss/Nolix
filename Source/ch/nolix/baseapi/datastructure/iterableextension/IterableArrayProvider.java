...
public interface IterableArrayProvider<E> {
  /**
   * @return a new array with the elements of the current {@link IterableArrayProvider}.
   */
  Object[] toArray();
   ...
   *         elements of the current {@link IterableArrayProvider}. Maps null elements to
   *         0
   ...
   *         of the current {@link IterableArrayProvider}. Maps null elements to 0. Maps
   *         null elements to 0
