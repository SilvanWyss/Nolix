...
/**
 * A {@link MutableOptionalSaveStampHolder} is a {@link OptionalSaveStampHolder}
 * whose save stamp can be set and removed programmatically.
 * 
 * @author Silvan Wyss
 */
public interface MutableOptionalSaveStampHolder extends OptionalSaveStampHolder {
  /**
   * Removes the save stamp of the current {@link MutableOptionalSaveStampHolder}.
   */
