...
/**
 * A {@link OptionalHeaderHolder} can have a header.
 * 
 * @author Silvan Wyss
 */
public interface OptionalHeaderHolder {
   ...
   *         {@link OptionalHeaderHolder} if the current
   *         {@link OptionalHeaderHolder} has a header has a header, an empty
  ...
  /**
   * @return true if the current {@link OptionalHeaderHolder} has a header, false
   *         otherwise
   */
  boolean hasHeader();
  ...
  /**
   * @param header
   * @return true if the current {@link OptionalHeaderHolder} has the given
