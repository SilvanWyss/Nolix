...
public interface Mappable<E> {
   ...
   */
  <T> IWellOrderContainer<T> to(Function<E, T> mapper);

  /**
   * @param multipleMapper
   * @param <T>            is the type of the elements of the {@link IWellOrderContainer}s
   *                       the given multipleMapper maps from the elements of the
   *                       current {@link Mappable}.
   * @return a new {@link IWellOrderContainer} with the elements of the {@link IWellOrderContainer}s
   ...
   *                          {@link Mappable} is null.
   */
  <T> IWellOrderContainer<T> toMultiples(Function<E, IWellOrderContainer<T>> multipleMapper);

  /**
   * @param numberMapper
   * @param <N>          is the type of the {@link Number}s the given numberMapper
   *                     maps from the elements of the current {@link Mappable}.
   * @return a new {@link IWellOrderContainer} with the {@link Number}s the given
   ...
   */
  <N extends Number> IWellOrderContainer<N> toNumbers(Function<E, N> numberMapper);

  /**
   * @return a new {@link IWellOrderContainer} with the {@link String} representations of
   *         the elements of the current {@link IWellOrderContainer}.
   */
  IWellOrderContainer<String> toStrings();
   ...
   *                          {@link Mappable} is null.
   */
  <T> IWellOrderContainer<T> toWithOneBasedIndex(BiFunction<Integer, E, T> mapper);
}
