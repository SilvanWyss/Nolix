...
public final class StyleCatalogue {
  ...
  new Style()
    .withSubStyle(
      ...
      DarkStyleSubStyleCatalogue.FOOTER_HORIZONTAL_STACK_STYLE,
      DarkStyleSubStyleCatalogue.GRID_STYLE,
      DarkStyleSubStyleCatalogue.HEADER_HORIZONTAL_STACK_STYLE,
      DarkStyleSubStyleCatalogue.LINEAR_CONTAINER_STYLE,
      DarkStyleSubStyleCatalogue.MAIN_CONTENT_CONTAINER_STYLE,
      DarkStyleSubStyleCatalogue.OVERALL_CONTAINER_VERTICAL_STACK_STYLE,
