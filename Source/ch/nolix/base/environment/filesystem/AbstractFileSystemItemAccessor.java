 ...
 * @author Silvan Wyss
 */
public abstract class AbstractFileSystemItemAccessor {
  private final File internalAccessor;

  /**
   * Creates a new {@link AbstractFileSystemItemAccessor }for the file system item
   * with the given path.
   * 
   * @param path
   ...
   */
  protected AbstractFileSystemItemAccessor(final String path) {
   ...
   *         {@link AbstractFileSystemItemAccessor}.
   */
   ...
   *         {@link AbstractFileSystemItemAccessor} has the given extension, false
   *         otherwise
   */
