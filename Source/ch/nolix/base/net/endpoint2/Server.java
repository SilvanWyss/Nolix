...
public final class Server extends AbstractServer {
  private final ch.nolix.base.net.endpoint.Server internalServer;
  ...
  private Server(final int port) {
    ...
    internalServer = ch.nolix.base.net.endpoint.Server.forPort(port);
  ...
  private Server(final int port, final String httpMessage) {
    //Creates the internal net server of the current net server.
    internalServer = ch.nolix.base.net.endpoint.Server.forPortAndInitialHttpMessage(port, httpMessage);
