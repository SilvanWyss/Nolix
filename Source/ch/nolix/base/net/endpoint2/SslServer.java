...
public final class SslServer extends AbstractServer {
  private final ch.nolix.base.net.endpoint.SslServer internalWebSocketServer;

  public SslServer(final int port, final String HtmlPage, final ISslCertificate paramSSLCertificate) {
    internalWebSocketServer = new ch.nolix.base.net.endpoint.SslServer(port, HtmlPage, paramSSLCertificate);
