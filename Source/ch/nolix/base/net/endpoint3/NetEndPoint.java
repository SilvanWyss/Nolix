...
public final class NetEndPoint extends AbstractEndPoint {
  ...
  public NetEndPoint(final String ip) {
    //Calls other constructor.
    this(ch.nolix.base.net.endpoint2.NetEndPoint.toGivenHostAndHttpPortAndDefaultSlot(ip));
  }
  ...
  public NetEndPoint(final String ip, final int port) {
    //Calls other constructor.
    this(ch.nolix.base.net.endpoint2.NetEndPoint.toGivenHostAndGivenPortAndDefaultSlot(ip, port));
  }
  ...
  public NetEndPoint(final String ip, final int port, final String targetSlot) {
    //Calls other constructor.
    this(new ch.nolix.base.net.endpoint2.NetEndPoint(ip, port, targetSlot));
  }
