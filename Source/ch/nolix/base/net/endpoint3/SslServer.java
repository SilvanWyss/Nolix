...
public final class SslServer extends AbstractServer {
  private final ch.nolix.base.net.endpoint2.SslServer internalWebSocketServer;

  private SslServer(final int port, final String HtmlPage, final ISslCertificate paramSSLCertificate) {
    internalWebSocketServer = new ch.nolix.base.net.endpoint2.SslServer(port, HtmlPage, paramSSLCertificate);
  ...
  protected void noteAddedDefaultSlot(final ISlot defaultSlot) {
    internalWebSocketServer.addDefaultSlot(Slot.withNameAndParentServer(defaultSlot.getName(), this));
  }
  ...
  protected void noteAddedSlot(final ISlot slot) {
    internalWebSocketServer.addSlot(Slot.withNameAndParentServer(slot.getName(), this));
  }
