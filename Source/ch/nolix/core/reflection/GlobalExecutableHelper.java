...
//class
/**
* The {@link GlobalExecutableHelper} provides methods to handle {@link Executable}s.
* Of the {@link GlobalExecutableHelper} an instance cannot be created.
* 
* @author Silvan Wyss
* @date 2023-01-22
*/
public final class GlobalExecutableHelper {
	 ...
	 * @param executable
	 * @param type
	 * @return true if all parameters of the given executable are of the given type, false otherwise.
	 */
	...
	//constructor
	/**
	 * Prevents that an instance of the {@link GlobalExecutableHelper} can be created.
	 */
