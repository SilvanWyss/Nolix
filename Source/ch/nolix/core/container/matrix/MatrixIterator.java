...
final class MatrixIterator<E> implements CopyableIterator<E> {
	...
	//constructor
	/**
	 * Creates a new {@link MatrixIterator} with the given parentMatrix and p1BasedStartIndex.
	 * 
	 * @param parentMatrix
	 * @param p1BasedStartIndex
	 * @throws ArgumentIsNullException if the given parentMatrix is null.
	 * @throws BiggerArgumentException if
	 * the given p1BasedStartIndex is bigger than the element count of the given parentMatrix.
	 */
