 ...
 * is supposed to be thrown when a given argument is undesirably bigger than a certain max.
 * 
 * @author Silvan Wyss
 * @date 2016-03-01
 */
...
public final class BiggerArgumentException extends InvalidArgumentException {
	 ...
	 * @param argument
	 * @param max
	 * @return a new {@link BiggerArgumentException} for the given argumentName, argument and max.
	...
	//constructor
	/**
	 * Creates a new {@link BiggerArgumentException} for the given argumentName, argument and max.
	 * 
	 * @param argumentName
	 * @param argument
	 * @param max
