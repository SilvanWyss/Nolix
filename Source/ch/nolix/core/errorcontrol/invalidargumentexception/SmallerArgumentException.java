 ...
 * is supposed to be thrown when a given argument is undesirably smaller than a certain limit.
 * 
 * @author Silvan Wyss
 * @date 2016-03-01
 */
...
public final class SmallerArgumentException extends InvalidArgumentException {
	...
	//constructor
	/**
	 * Creates a new {@link SmallerArgumentException} for the given argumentName, argument and limit.
	 * 
	 * @param argumentName
	 * @param argument
	 * @param limit
