...
//class
/**
 * A {@link PositiveArgumentException} is a {@link InvalidArgumentException} that
 * is supposed to be thrown when a given argument is undesirably positive.
 * 
 * @author Silvan Wyss
 * @date 2017-01-01
 */
...
public final class PositiveArgumentException extends InvalidArgumentException {
	 ...
	 * @param argumentName
	 * @param argument
	 * @return a new {@link PositiveArgumentException} for the given argumentName and argument.
	...
	//constructor
	/**
	 * Creates a new {@link PositiveArgumentException} for the given argumentName and argument.
	 * 
	 * @param argumentName
	 * @param argument
	 * @throws IllegalArgumentException if the given argumentName is null.
