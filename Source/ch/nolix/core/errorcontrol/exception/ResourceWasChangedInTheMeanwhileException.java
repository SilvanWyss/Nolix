...
//class
/**
 * A {@link ResourceWasChangedInTheMeanwhileException} is a {@link RuntimeException} that is
 * supposed to be thrown when a specific resource was undesirably changed in the meanwhile.
 * For thhis conext, a resource can be e.g.: data, schema, file, connection.
 * 
 * @author Silvan Wyss
 * @date 2022-02-27
 */
...
public final class ResourceWasChangedInTheMeanwhileException extends RuntimeException {
	...
	/**
	 * @param resource
	 * @return a new {@link ResourceWasChangedInTheMeanwhileException} for the given resource.
	...
	//constructor
	/**
	 * Creates a new {@link ResourceWasChangedInTheMeanwhileException} for the given resource.
	 * 
	 * @param resource
	 * @throws IllegalArgumentException if the given resource is null.
	 * @throws IllegalArgumentException if the given resource is blank.
