...
public abstract class FrontendClient<FC extends FrontendClient<FC>> extends Client<FC> {
	...
	//method
	/**
	 * Connects the current {@link FrontendClient} to the default {@link Application} on the given server.
	 * 
	 * @param server
	 * @throws InvalidArgumentException if the current {@link FrontendClient} is already connected.
	 */
	 ...
	 * the default {@link Application} on the given port on the local computer.
	 * 
	 * @param port
	...
	/**
	 * Connects the current {@link FrontendClient} to
	 * the {@link Application} with the given name on the given port on the local computer.
	 * 
	 * @param port
	 * @param name
	 * @throws ArgumentIsOutOfRangeException if the given port is not in [0, 65535].
	...
	/**
	 * Connects the current {@link FrontendClient} to
	 * the default {@link Application} on given port on the computer with the given ip.
	 * 
	 * @param ip
	 * @param port
	 * @throws ArgumentIsOutOfRangeException if the given port is not in [0, 65535].
	...
	/**
	 * Connects the current {@link FrontendClient} to
	 * the {@link Application} with the given name on the given port on the computer with the given ip.
	 * 
	 * @param ip
	 * @param port
	 * @param name
