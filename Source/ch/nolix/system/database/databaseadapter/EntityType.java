...
public final class EntityType<E extends Entity> implements Named {
	...
	//method
	public ch.nolix.system.objectschema.databaseschemaadapter.EntitySet toEmptySchemaEntitySet() {
		return new ch.nolix.system.objectschema.databaseschemaadapter.EntitySet(getName());
	}
	
	//method
	public void fillUpColumnsInOwnSchemaEntitySetFrom(
		final IContainer<ch.nolix.system.objectschema.databaseschemaadapter.EntitySet> entitySets
	) {
	...
	private void fillUpColumnsInOnwSchemaEntitySet(
		final ch.nolix.system.objectschema.databaseschemaadapter.EntitySet ownEntitySet,
	...
	//method
	private LinkedList<ch.nolix.system.objectschema.databaseschemaadapter.Column> getSchemaColumns(
		IContainer<ch.nolix.system.objectschema.databaseschemaadapter.EntitySet> schemaEntitySets
	) {
