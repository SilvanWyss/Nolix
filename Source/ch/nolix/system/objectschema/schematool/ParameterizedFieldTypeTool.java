...
implements IParameterizedFieldTypeTool {
  ...
  public boolean isABaseBackReferenceType(final IParameterizedFieldType parameterizedFieldType) {
    return (parameterizedFieldType.getPropertyType().getBaseType() == BasePropertyType.BASE_BACK_REFERENCE);
  }

  //method
  @Override
  public boolean isABaseReferenceType(IParameterizedFieldType parameterizedFieldType) {
    return (parameterizedFieldType.getPropertyType().getBaseType() == BasePropertyType.BASE_REFERENCE);
  }

  //method
  @Override
  public boolean isABaseValueType(IParameterizedFieldType parameterizedFieldType) {
    return (parameterizedFieldType.getPropertyType().getBaseType() == BasePropertyType.BASE_VALUE);
  }
}
