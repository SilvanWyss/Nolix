...
public final class BackReferenceModelView<C extends IColumnView> extends AbstractBackReferenceModelView<C> {

  private BackReferenceModelView(final C backReferencedColumn) {
    super(backReferencedColumn);
  }

  public static <C2 extends IColumnView> BackReferenceModelView<C2> forBackReferencedColumn(
