...
public final class EntitySaver implements IEntitySaver {
   ...
   */
  @Override
  public void saveEntityChanges(final Entity entity, final DataAdapterAndSchemaReader dataAndSchemaAdapter) {
   ...
   */
  @Override
  public void saveEntityCreation(final Entity entity, final DataAdapterAndSchemaReader dataAndSchemaAdapter) {
   ...
   */
  @Override
  public void saveEntityDeletion(final Entity entity, final DataAdapterAndSchemaReader dataAndSchemaAdapter) {
    final var tableName = entity.getStoredParentTable().getName();
   ...
   */
  @Override
  public void saveEntityUpdates(final Entity entity, final DataAdapterAndSchemaReader dataAndSchemaAdapter) {
    final var tableName = entity.getStoredParentTable().getName();
