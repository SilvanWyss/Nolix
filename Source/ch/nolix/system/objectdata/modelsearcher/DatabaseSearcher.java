...
public final class DatabaseSearcher implements IDatabaseSearcher {
   ...
   */
  @Override
  public ExtendedIterable<Entity> getStoredEntitiesInLocalData(final IDatabase database) {
    if (database == null) {
   ...
   */
  @Override
  public ITable<Entity> getStoredTableById(final IDatabase database, final String tableId) {
