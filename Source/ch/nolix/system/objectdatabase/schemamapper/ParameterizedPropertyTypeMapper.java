...
public final class ParameterizedPropertyTypeMapper implements IParameterizedPropertyTypeMapper {
  ...
  public IParameterizedPropertyType createParameterizedPropertyTypeFromGivenPropertyUsingGivenReferencableTables(
    ...
    switch (property.getType()) {
      ...
      case MULTI_VALUE:
        return ParameterizedMultiValueType.forDataType(DataType.forType(PROPERTY_HELPER.getDataType(property)));
      case REFERENCE:
      ...
      case OPTIONAL_BACK_REFERENCE:
        ...
        return ParameterizedOptionalBackReferenceType.forBackReferencedColumn(
          referencableTables
      ...
      case MULTI_BACK_REFERENCE:
        ...
        return ParameterizedMultiBackReferenceType.forBackReferencedColumn(
          referencableTables
