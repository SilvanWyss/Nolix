...
public final class ShowValueDialogBuilderTutorial {
	...
	private static final class MainSession extends WebClientSession<Object> {
		...
		private void showDate() {
			...
			String.format("%02d.%02d.%04d", time.getDayOfMonth(), time.getMonthOfYearAsInt(), time.getYearAsInt());
			
			final var showDateDialog =
			new ShowValueDialogBuilder().setValueName(LowerCaseCatalogue.DATE).setValue(dateString).build();
