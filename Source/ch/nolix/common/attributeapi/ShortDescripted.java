 ...
 * 
 * A short description is a {@link String} representation of an object,
 * that can identify the object, but is mostly shorter than the object's common {@link String} representation.
 * 
 * Example 1:
 * There is given a person (surname: Peter, name: Muster, date of birth: 01.01.2000, hair color: brown, hobby: fishing).
 * -{@link String} representation: "Peter, Muster, 2000-01-01, brown, fishing"
 * -short description: "Peter Muster, 2001-01-01"
 * 
 * Example 2:
 * There is given a package (index: 25000, content: HelloWorld).
 * -{@link String} representation: "25000, HelloWorld"
