...
public abstract class StandardTest extends Test {
	...
	protected final void expectApproximativeEquality(final ApproximativeEqualing expectedValue, final ApproximativeEqualing actualValue) { 
		if (expectedValue != null && actualValue == null) {
			addCurrentTestMethodError("Expected value is an object, but actual value is null.");
		}
		if (expectedValue == null && actualValue != null) {
			addCurrentTestMethodError("Expected value is null, but actual value is an object.");
		}
		if (expectedValue != null && actualValue != null && !expectedValue.equalsApproximatively(actualValue)) {
			addCurrentTestMethodError("'" + expectedValue.toString() + "' was expected, but '" + actualValue.toString() + "' was received, what does not equal.");
		}
	}
	...
	protected final void expectApproximativeEquality(double expectedValue, double actualValue) {
		if (Math.abs(expectedValue - actualValue) > EPSILON) {
			addCurrentTestMethodError("Approximatively '" + expectedValue + "' was expected, but '" + actualValue + "' was received.");
		}
	}
	...
	protected final void expectBiggerValue(double min, double value) {
		if (value <= min) {
			addCurrentTestMethodError("A value bigger than " + min + " was expected, but " + value + " was received.");
		}
	}
	...
	protected final void expectEmptyString(String string) {
		if (string == null) {
			addCurrentTestMethodError("Empty string was expected, but null was received.");
		}
		if (string.length() > 0) {
			addCurrentTestMethodError("Empty string was expected, but '" + string + "' was received.");
		}
	}
	...
	protected final void expectEquality(double expectedValue, double actualValue) {
		if (expectedValue != actualValue) {
			addCurrentTestMethodError("'" + expectedValue + "' was expected, but '" + actualValue + "' was received.");
		}
	}
	...
	protected final void expectEquality(Object expectedValue, Object actualValue) {
		...
		if (expectedValue == null && actualValue != null) {
			addCurrentTestMethodError("Null was expected, but " + actualValue + " was received.");
		}
	...
	protected final void expectFalse(boolean boolean_) {
		if (boolean_ == true) {
			addCurrentTestMethodError("False boolean was expected, but true was received.");
		}
	}
	...
	protected final void expectNegativeValue(double value) {
		if (value >= 0) {
			addCurrentTestMethodError("Negative value was expected, but " + value + " was received.");
		}
	}
	...
	protected final void expectNoEquality(Object value1, Object value2) {
		if ((value1 == null && value2 == null) || (value1 != null && value2 != null && value1.equals(value2))) {
			addCurrentTestMethodError("Two unequal values were expected, but two equal values were received");
		}
	}
	...
	protected final void expectNonEmptyString(String string) {
		...
		if (string == null) {
			addCurrentTestMethodError("Non-empty string was expected, but null was received.");
		}
		
		//Handles the case if the given string is empty.
		if (string.length() == 0) {
			addCurrentTestMethodError("Non-empty string was expected, but empty string was received.");
		}
	}
	...
	protected final void expectNotZero(double value) {
		if (value == 0) {
			addCurrentTestMethodError("Non zero value was expected, but 0 was received.");
		}
	}
	...
	protected final void expectNull(Object object_) {
		if (object_ != null) {
			addCurrentTestMethodError("Null was expected, but a " + object_.getClass().getSimpleName() + " was received");
		}
	}
	...
	protected final void expectObject(Object reference) {
		if (reference == null) {
			addCurrentTestMethodError("Object was expected, but null was received.");
		}
	}
	...
	protected final void expectPositiveValue(double value) {
		if (value <= 0) {
			addCurrentTestMethodError("Positive value was expected, but " + value + " was received");
		}
	}	
	...
	protected final void expectSmallerValue(double max, double value) {
		if (value >= max) {
			addCurrentTestMethodError("A value smaller than " + max + " was expected, but " + value + " was received.");
		}
	}
	...
	protected final void expectTrue(boolean boolean_) {
		if (boolean_ == false) {
			addCurrentTestMethodError("True boolean was expected, but false was received.");
		}
	}
