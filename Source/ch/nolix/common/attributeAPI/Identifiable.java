...
//interface
/**
 * A {@link Identifiable} is a {@link Identified} whose id can be set and removed programmatically.
 * 
 * @author Silvan Wyss
 * @month 2020-03
 * @lines 30
...
public interface Identifiable<I> extends Identified {
	...
	//method declaration
	/**
	 * Removes the id of the current {@link Identifiable}.
	 * 
	 * @return the current {@link Identifiable}.
	 */
	public abstract I removeId();
